(function () {
  ...
  TasksAdminController.$inject = ['$scope', '$state', '$window', 'taskResolve', 'Authentication', 'Notification'];

  function TasksAdminController($scope, $state, $window, task, Authentication, Notification) {
    var vm = this;
